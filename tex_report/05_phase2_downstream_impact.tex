...
decomposition}, and it is reported as unresolved. A design that holds
the learner fixed by construction --- injecting controlled noise rather
than switching label sources --- would make the question answerable, and
that is how Phase 3 approaches it.
