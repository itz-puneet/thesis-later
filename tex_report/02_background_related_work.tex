...
report, taken as published rather than recomputed so that feature
...
consistent in direction with this report's: in-sample performance is
...
evolution} is the setting this report adopts.
...
report's choice of \emph{W} = 90 days.} \textbf{The distinction from the
...
loss-correction arm evaluated in this report is capped.
