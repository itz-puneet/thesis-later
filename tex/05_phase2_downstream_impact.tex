...
\textbf{Phases 1--3 are exploratory and are labelled as such
throughout.} Only Phase 4 is pre-registered.
...
+0.0353. \textbf{No MCC is quoted anywhere in this thesis without naming
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f2_inflation_ladder.png}
...
difference between the first and last bar is this thesis in one
picture.}

The ladder must be read as \textbf{descriptive, not causal}. Step 3
changes the learner, the regime and the evaluation window
simultaneously. \S{}5.3 explains why an earlier attempt to decompose it was
withdrawn.
...
\textbf{+0.2303 MCC is the largest effect in this thesis.} It is also
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f3_self_deception.png}
...
certainly not explained by this structure alone.} The claim this thesis
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f4_label_source.png}
...
labeller finds --- a point Chapter 6 returns to and resolves.
...
trajectory. They agree on every comparison in this thesis except one:
...
both summaries are ad-hoc, and this thesis says so rather than claiming
canonical status for either.

\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f7_estimators.png}
...
\section{5.3 An honest negative---}\label{an-honest-negative}

\section{5.3 An honest negative: the batch-to-stream contrast could not
be
isolated}\label{an-honest-negative-the-batch-to-stream-contrast-could-not-be-isolated}

An earlier version of this work reported that verification latency
accounts for roughly 9\% of the drop from batch to streaming
performance. \textbf{That claim has been withdrawn, and the withdrawal
is reported here rather than removed.}

The comparison was not identified. It changed three things at once: the
learner (forest \ensuremath{\rightarrow} online ensemble), the label timing (immediate \ensuremath{\rightarrow}
delayed), and the evaluation window (a held-out second half \ensuremath{\rightarrow} the whole
stream). Any of the three could produce the observed difference.

A full 2\ensuremath{\times}2 factorial --- learner (frozen / adaptive) crossed with labels
(immediate / delayed) --- was built to isolate the effects:
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f5_decomposition.png}
...
The honest conclusion is that \textbf{21 projects cannot resolve the
decomposition}, and it is reported as unresolved. Chapter 6 returns to
the latency question with a design that holds the learner fixed by
construction, and there the question does become answerable.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f8_jitline_anomaly.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth,keepaspectratio]{reports/figures/f9_anomaly_predictors.png}
...
is consistent with Chapter 6's account of what an online learner is
actually sensitive to.

\textbf{How this is stated in the thesis:} the phenomenon is robust and
...
That question is the subject of Chapter 6, and answering it requires an
intervention rather than an observation.
